/********************************************************************************
** Form generated from reading UI file 'designerPYNsBg.ui'
**
...
#ifndef DESIGNERPYNSBG_H
#define DESIGNERPYNSBG_H
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        file_edit_text = new QPlainTextEdit(frame_9);
        ...
        grah_view = new QGraphicsView(tab);
        grah_view->setObjectName(QString::fromUtf8("grah_view"));
        grah_view->setAutoFillBackground(false);

        verticalLayout_2->addWidget(grah_view);
        ...
        runge_kutta_text_browser->setObjectName(QString::fromUtf8("runge_kutta_text_browser"));
    ...
    {
        MainWindow->setWindowTitle(QCoreApplication::translate("MainWindow", "Lab 6", nullptr));
        ...
        label_5->setText(QCoreApplication::translate("MainWindow", "epsilon", nullptr));
        calc_btn->setText(QCoreApplication::translate("MainWindow", "Calculate", nullptr));
        label_6->setText(QCoreApplication::translate("MainWindow", "\320\236\320\224\320\243", nullptr));
        first_eq->setText(QString());
        label_7->setText(QCoreApplication::translate("MainWindow", "-2.0 * y  * x ^2", nullptr));
        sec_eq->setText(QString());
        label_8->setText(QCoreApplication::translate("MainWindow", "x^3 - 2 * y", nullptr));
        thrd_eq->setText(QString());
        label_9->setText(QCoreApplication::translate("MainWindow", "y * cos(x)", nullptr));
        label_10->setText(QCoreApplication::translate("MainWindow", "Load data from file", nullptr));
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab), QCoreApplication::translate("MainWindow", "Graph", nullptr));
        tabWidget_2->setTabText(tabWidget_2->indexOf(tab_3), QCoreApplication::translate("MainWindow", "Adams", nullptr));
        tabWidget_2->setTabText(tabWidget_2->indexOf(tab_4), QCoreApplication::translate("MainWindow", "Euler", nullptr));
        tabWidget_2->setTabText(tabWidget_2->indexOf(tab_5), QCoreApplication::translate("MainWindow", "Runge Kutta 4", nullptr));
